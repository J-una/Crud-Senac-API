    ...
    public class ClienteService : IClienteInterface
    {
        ...
        public async Task<Response<Cliente>> CriarCliente(Cliente novoCliente)
        {
            try
            {
                ...
                if (string.IsNullOrWhiteSpace(novoCliente.Senha))
                    throw new ArgumentException("Senha é obrigatória.");
                novoCliente.Senha = BCrypt.Net.BCrypt.HashPassword(novoCliente.Senha, workFactor: 10);
        ...
        public async Task<Response<Cliente>> AtualizarCliente(Guid idCliente, Cliente clienteAtualizado)
        {
            ...
            {
                cliente.Senha = BCrypt.Net.BCrypt.HashPassword(cliente.Senha, workFactor: 10);
            }
